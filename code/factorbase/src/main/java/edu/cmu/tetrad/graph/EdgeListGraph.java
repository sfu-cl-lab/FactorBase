...
public final class EdgeListGraph implements Graph {
    ...
    public EdgeListGraph(Graph graph) throws IllegalArgumentException {
        ...
        this();
       // System.out.println("entering : EdgeListGraph(Graph graph)");
        if (graph == null) {
       ...
       // System.out.println("left : EdgeListGraph(Graph graph)");
    }
...
*/
    ...
    // here is the problem?? OCT 30
    @Override
	public void transferNodesAndEdges(Graph graph)
            throws IllegalArgumentException {
    	//System.out.println(" ##### EdgeListGraph(Graph graph/transferNodesAndEdges(Graph graph) ");
        ...
        for (Object o1 : graph.getEdges()) {
            Edge edge = (Edge) o1;
            //###########################OCT 30, zqian###########################################//
            if (!addEdge(edge)) {//// addEdge(edge) is the problem?? OCT 30
            	//#######################OCT 30, zqian###############################################//
            //@Aug 27
    	...
    	//System.out.println(" left##### EdgeListGraph(Graph graph/transferNodesAndEdges(Graph graph) ");
    }
...
//        }
	...
	public boolean addEdge(Edge edge) {
    	//######################checkAddEdge(edge)######zqian###################//
        if (isGraphConstraintsChecked() && !checkAddEdge(edge)) {
        //@Aug 27
        	
        System.out.println("Violate Constraints\n");
        System.out.println("NO Need To Add This Edge @ Zqian OCT 31 2013\n");
        return false;
           /* throw new IllegalArgumentException(
...
//        Set<Triple> ambiguousTriples = getAmbiguousTriples();
	...
	public Set<Triple> getAmbiguousTriples() {
       ...
       // System.out.println("left : getAmbiguousTriples()");
...
//        }
    ...
    private boolean checkAddEdge(Edge edge) {
        for (GraphConstraint graphConstraint : graphConstraints) {
            GraphConstraint gc = (graphConstraint);
//#############HAVE TO MODIFY THIS PART, Zqian OCT 30#################################//
            if (!gc.isEdgeAddable(edge, this)) {
            	System.out.println("Finally, GOT YOU, zqian, OCT 30");
