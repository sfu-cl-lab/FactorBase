...
INSERT INTO `PVariables_GroupBy_List` VALUES ('Bio0','`activity(Bio0)`'),('dispat0','`age(dispat0)`'),('indis0','`alb(indis0)`'),('indis0','`che(indis0)`'),('indis0','`dbil(indis0)`'),('inf0','`dur(inf0)`'),('Bio0','`fibros(Bio0)`'),('indis0','`got(indis0)`'),('indis0','`gpt(indis0)`'),('dispat0','`sex(dispat0)`'),('indis0','`tbil(indis0)`'),('indis0','`tcho(indis0)`'),('indis0','`tp(indis0)`'),('indis0','`ttt(indis0)`'),('dispat0','`Type(dispat0)`'),('indis0','`ztt(indis0)`');
