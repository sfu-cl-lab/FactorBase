...
INSERT INTO `ADT_RNodes_1Nodes_Select_List` VALUES ('`a`','sum(`a_counts`.`MULT`) as \"MULT\"'),('`b`','sum(`b_counts`.`MULT`) as \"MULT\"'),('`c`','sum(`c_counts`.`MULT`) as \"MULT\"'),('`a`','`activity(Bio0)`'),('`b`','`alb(indis0)`'),('`b`','`che(indis0)`'),('`b`','`dbil(indis0)`'),('`c`','`dur(inf0)`'),('`a`','`fibros(Bio0)`'),('`b`','`got(indis0)`'),('`b`','`gpt(indis0)`'),('`b`','`tbil(indis0)`'),('`b`','`tcho(indis0)`'),('`b`','`tp(indis0)`'),('`b`','`ttt(indis0)`'),('`b`','`ztt(indis0)`'),('`a`','`age(dispat0)`'),('`b`','`age(dispat0)`'),('`c`','`age(dispat0)`'),('`a`','`sex(dispat0)`'),('`b`','`sex(dispat0)`'),('`c`','`sex(dispat0)`'),('`a`','`Type(dispat0)`'),('`b`','`Type(dispat0)`'),('`c`','`Type(dispat0)`');
