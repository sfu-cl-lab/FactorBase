...
INSERT INTO `RNodes` VALUES ('`rel11(Bio0,dispat0)`','rel11','Bio0','dispat0','b_id','m_id',1,'`a`'),('`rel12(indis0,dispat0)`','rel12','indis0','dispat0','in_id','m_id',1,'`b`'),('`rel13(inf0,dispat0)`','rel13','inf0','dispat0','a_id','m_id',1,'`c`');
