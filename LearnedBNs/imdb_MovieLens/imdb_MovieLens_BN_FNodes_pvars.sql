...
INSERT INTO `FNodes_pvars` VALUES ('`cast_num(movies0,actors0)`','movies0'),('`genre(movies0,directors0)`','movies0'),('`rating(users0,movies0)`','users0'),('`cast_num(movies0,actors0)`','actors0'),('`genre(movies0,directors0)`','directors0'),('`rating(users0,movies0)`','movies0'),('`age(users0)`','users0'),('`avg_revenue(directors0)`','directors0'),('`a_gender(actors0)`','actors0'),('`a_quality(actors0)`','actors0'),('`country(movies0)`','movies0'),('`d_quality(directors0)`','directors0'),('`isEnglish(movies0)`','movies0'),('`occupation(users0)`','users0'),('`runningtime(movies0)`','movies0'),('`u_gender(users0)`','users0'),('`year(movies0)`','movies0');
