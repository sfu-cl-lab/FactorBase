...
INSERT INTO `RNodes_BN_Nodes` VALUES ('`c`','`age(users0)`',1),('`a`','`country(movies0)`',1),('`b`','`country(movies0)`',1),('`a`','`isEnglish(movies0)`',1),('`b`','`isEnglish(movies0)`',1),('`c`','`occupation(users0)`',1),('`a`','`runningtime(movies0)`',1),('`b`','`runningtime(movies0)`',1),('`c`','`u_gender(users0)`',1),('`a`','`year(movies0)`',1),('`b`','`year(movies0)`',1),('`b`','`avg_revenue(directors0)`',1),('`a`','`a_gender(actors0)`',1),('`a`','`a_quality(actors0)`',1),('`c`','`country(movies0)`',1),('`b`','`d_quality(directors0)`',1),('`c`','`isEnglish(movies0)`',1),('`c`','`runningtime(movies0)`',1),('`c`','`year(movies0)`',1),('`a`','`cast_num(movies0,actors0)`',1),('`b`','`genre(movies0,directors0)`',1),('`c`','`rating(users0,movies0)`',1);
