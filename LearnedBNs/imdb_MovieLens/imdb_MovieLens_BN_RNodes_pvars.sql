...
INSERT INTO `RNodes_pvars` VALUES ('`a`','movies0','movies','movieid','movieid'),('`b`','movies0','movies','movieid','movieid'),('`c`','users0','users','userid','userid'),('`a`','actors0','actors','actorid','actorid'),('`b`','directors0','directors','directorid','directorid'),('`c`','movies0','movies','movieid','movieid');
