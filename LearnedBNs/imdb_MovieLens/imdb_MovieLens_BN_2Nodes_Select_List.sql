...
INSERT INTO `2Nodes_Select_List` VALUES ('`cast_num(movies0,actors0)`','`a`.cast_num AS `cast_num(movies0,actors0)`'),('`genre(movies0,directors0)`','`b`.genre AS `genre(movies0,directors0)`'),('`rating(users0,movies0)`','`c`.rating AS `rating(users0,movies0)`');
