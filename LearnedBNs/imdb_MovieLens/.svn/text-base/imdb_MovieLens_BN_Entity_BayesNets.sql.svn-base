...
INSERT INTO `Entity_BayesNets` VALUES ('actors0','`a_gender(actors0)`',''),('actors0','`a_quality(actors0)`','`a_gender(actors0)`'),('directors0','`avg_revenue(directors0)`','`d_quality(directors0)`'),('directors0','`d_quality(directors0)`',''),('movies0','`country(movies0)`','`isEnglish(movies0)`'),('movies0','`country(movies0)`','`year(movies0)`'),('movies0','`isEnglish(movies0)`',''),('movies0','`runningtime(movies0)`','`year(movies0)`'),('movies0','`year(movies0)`',''),('users0','`age(users0)`',''),('users0','`occupation(users0)`','`age(users0)`'),('users0','`u_gender(users0)`','`occupation(users0)`');
