...
INSERT INTO `2Nodes` VALUES ('`cast_num(movies0,actors0)`','cast_num','movies0','actors0','movies2actors',1),('`genre(movies0,directors0)`','genre','movies0','directors0','movies2directors',1),('`rating(users0,movies0)`','rating','users0','movies0','u2base',1);
