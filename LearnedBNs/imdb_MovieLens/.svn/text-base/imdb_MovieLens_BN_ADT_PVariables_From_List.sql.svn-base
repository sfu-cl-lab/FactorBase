...
INSERT INTO `ADT_PVariables_From_List` VALUES ('actors0','imdb_MovieLens.actors AS actors0'),('directors0','imdb_MovieLens.directors AS directors0'),('movies0','imdb_MovieLens.movies AS movies0'),('users0','imdb_MovieLens.users AS users0');
