...
INSERT INTO `RNodes_Where_List` VALUES ('`a`','`a`.movieid = movies0.movieid'),('`b`','`b`.movieid = movies0.movieid'),('`c`','`c`.userid = users0.userid'),('`a`','`a`.actorid = actors0.actorid'),('`b`','`b`.directorid = directors0.directorid'),('`c`','`c`.movieid = movies0.movieid');
