...
INSERT INTO `ADT_PVariables_GroupBy_List` VALUES ('users0','`age(users0)`'),('directors0','`avg_revenue(directors0)`'),('actors0','`a_gender(actors0)`'),('actors0','`a_quality(actors0)`'),('movies0','`country(movies0)`'),('directors0','`d_quality(directors0)`'),('movies0','`isEnglish(movies0)`'),('users0','`occupation(users0)`'),('movies0','`runningtime(movies0)`'),('users0','`u_gender(users0)`'),('movies0','`year(movies0)`');
...
-- Dump completed on 2013-08-30 16:38:55
