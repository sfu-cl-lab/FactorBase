...
INSERT INTO `InputColumns` VALUES ('course','course_id',NULL,NULL,'PRIMARY',1),('prof','prof_id',NULL,NULL,'PRIMARY',1),('RA','student_id',NULL,NULL,'PRIMARY',3),('RA','prof_id',NULL,NULL,'PRIMARY',2),('registration','student_id',NULL,NULL,'PRIMARY',2),('registration','course_id',NULL,NULL,'PRIMARY',1),('student','student_id',NULL,NULL,'PRIMARY',1);
