...
INSERT INTO `ADT_RNodes_1Nodes_GroupBY_List` VALUES ('`b`','`diff(course0)`'),('`a`','`popularity(prof0)`'),('`b`','`rating(course0)`'),('`a`','`teachingability(prof0)`'),('`a`','`intelligence(student0)`'),('`b`','`intelligence(student0)`'),('`a`','`ranking(student0)`'),('`b`','`ranking(student0)`');
