...
INSERT INTO `Entity_Complement_Edges` VALUES ('course0','`diff(course0)`','`diff(course0)`'),('course0','`diff(course0)`','`rating(course0)`'),('course0','`rating(course0)`','`diff(course0)`'),('course0','`rating(course0)`','`rating(course0)`'),('prof0','`popularity(prof0)`','`popularity(prof0)`'),('prof0','`teachingability(prof0)`','`popularity(prof0)`'),('prof0','`teachingability(prof0)`','`teachingability(prof0)`'),('student0','`intelligence(student0)`','`intelligence(student0)`'),('student0','`intelligence(student0)`','`ranking(student0)`'),('student0','`ranking(student0)`','`ranking(student0)`');
