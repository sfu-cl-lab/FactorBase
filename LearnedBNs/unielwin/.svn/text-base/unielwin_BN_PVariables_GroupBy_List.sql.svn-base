...
INSERT INTO `PVariables_GroupBy_List` VALUES ('course0','`diff(course0)`'),('student0','`intelligence(student0)`'),('prof0','`popularity(prof0)`'),('student0','`ranking(student0)`'),('course0','`rating(course0)`'),('prof0','`teachingability(prof0)`');
