...
INSERT INTO `RNodes_From_List` VALUES ('`a`','unielwin.prof AS prof0'),('`b`','unielwin.course AS course0'),('`a`','unielwin.student AS student0'),('`b`','unielwin.student AS student0'),('`a`','unielwin.RA AS `a`'),('`b`','unielwin.registration AS `b`'),('`a`','(select \"T\" as `a`) as `temp_a`'),('`b`','(select \"T\" as `b`) as `temp_b`');
