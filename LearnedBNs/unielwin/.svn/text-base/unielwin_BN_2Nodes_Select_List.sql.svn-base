...
INSERT INTO `2Nodes_Select_List` VALUES ('`capability(prof0,student0)`','`a`.capability AS `capability(prof0,student0)`'),('`grade(course0,student0)`','`b`.grade AS `grade(course0,student0)`'),('`salary(prof0,student0)`','`a`.salary AS `salary(prof0,student0)`'),('`sat(course0,student0)`','`b`.sat AS `sat(course0,student0)`');
