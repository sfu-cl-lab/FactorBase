...
INSERT INTO `RNodes_BN_Nodes` VALUES ('`b`','`diff(course0)`',1),('`a`','`intelligence(student0)`',1),('`b`','`intelligence(student0)`',1),('`a`','`popularity(prof0)`',1),('`a`','`ranking(student0)`',1),('`b`','`ranking(student0)`',1),('`b`','`rating(course0)`',1),('`a`','`teachingability(prof0)`',1),('`a`','`capability(prof0,student0)`',1),('`b`','`grade(course0,student0)`',1),('`a`','`salary(prof0,student0)`',1),('`b`','`sat(course0,student0)`',1);
