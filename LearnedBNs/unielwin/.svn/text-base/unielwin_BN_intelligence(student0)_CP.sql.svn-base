...
--
-- Table structure for table `intelligence(student0)_CP`
--

DROP TABLE IF EXISTS `intelligence(student0)_CP`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `intelligence(student0)_CP` (
...
--
-- Dumping data for table `intelligence(student0)_CP`
--

LOCK TABLES `intelligence(student0)_CP` WRITE;
/*!40000 ALTER TABLE `intelligence(student0)_CP` DISABLE KEYS */;
INSERT INTO `intelligence(student0)_CP` VALUES ('800','1','F',2030,0.394089,-0.931178),('40','1','T',250,0.160000,-1.83258),('650','2','F',2030,0.320197,-1.13882),('130','2','T',250,0.520000,-0.653926),('580','3','F',2030,0.285714,-1.25276),('80','3','T',250,0.320000,-1.13943);
