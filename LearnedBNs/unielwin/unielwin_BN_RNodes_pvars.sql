...
INSERT INTO `RNodes_pvars` VALUES ('`a`','prof0','prof','prof_id','prof_id'),('`b`','course0','course','course_id','course_id'),('`a`','student0','student','student_id','student_id'),('`b`','student0','student','student_id','student_id');
