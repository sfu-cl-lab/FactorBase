...
--
-- Table structure for table `capability(prof0,student0)_CP`
--

DROP TABLE IF EXISTS `capability(prof0,student0)_CP`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `capability(prof0,student0)_CP` (
...
--
-- Dumping data for table `capability(prof0,student0)_CP`
--

LOCK TABLES `capability(prof0,student0)_CP` WRITE;
/*!40000 ALTER TABLE `capability(prof0,student0)_CP` DISABLE KEYS */;
INSERT INTO `capability(prof0,student0)_CP` VALUES ('50','1','T',250,0.200000,-1.60944),('40','2','T',250,0.160000,-1.83258),('70','3','T',250,0.280000,-1.27297),('50','4','T',250,0.200000,-1.60944),('40','5','T',250,0.160000,-1.83258),('2030','N/A','F',2030,1.000000,0);
