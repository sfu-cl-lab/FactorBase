...
INSERT INTO `InheritedEdges` VALUES ('`a,b`','`capability(prof0,student0)`','`a`'),('`a,b`','`diff(course0)`','`grade(course0,student0)`'),('`a,b`','`grade(course0,student0)`','`b`'),('`a,b`','`grade(course0,student0)`','`intelligence(student0)`'),('`a,b`','`intelligence(student0)`','`a`'),('`a,b`','`popularity(prof0)`','`a`'),('`a,b`','`popularity(prof0)`','`teachingability(prof0)`'),('`a,b`','`ranking(student0)`','`intelligence(student0)`'),('`a,b`','`salary(prof0,student0)`','`a`'),('`a,b`','`salary(prof0,student0)`','`capability(prof0,student0)`'),('`a,b`','`sat(course0,student0)`','`b`'),('`a,b`','`sat(course0,student0)`','`grade(course0,student0)`');
