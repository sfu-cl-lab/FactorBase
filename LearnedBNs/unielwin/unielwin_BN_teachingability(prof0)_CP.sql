...
--
-- Table structure for table `teachingability(prof0)_CP`
--

DROP TABLE IF EXISTS `teachingability(prof0)_CP`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `teachingability(prof0)_CP` (
...
--
-- Dumping data for table `teachingability(prof0)_CP`
--

LOCK TABLES `teachingability(prof0)_CP` WRITE;
/*!40000 ALTER TABLE `teachingability(prof0)_CP` DISABLE KEYS */;
INSERT INTO `teachingability(prof0)_CP` VALUES ('2',0.500000,1140,-0.693147),('3',0.500000,1140,-0.693147);
