...
INSERT INTO `ADT_RNodes_False_FROM_List` VALUES ('`a`','`a_star`'),('`b`','`b_star`'),('`c`','`c_star`'),('`d`','`d_star`'),('`e`','`e_star`'),('`f`','`f_star`'),('`a`','`a_flat`'),('`b`','`b_flat`'),('`c`','`c_flat`'),('`d`','`d_flat`'),('`e`','`e_flat`'),('`f`','`f_flat`');
