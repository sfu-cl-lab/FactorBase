...
INSERT INTO `RNodes_2Nodes` VALUES ('`a`','`dribble_eff_PA(Players0,MatchComp0)`'),('`b`','`dribble_eff_PH(Players1,MatchComp0)`'),('`a`','`passes_eff_PA(Players0,MatchComp0)`'),('`b`','`passes_eff_PH(Players1,MatchComp0)`'),('`a`','`SavesMade_PA(Players0,MatchComp0)`'),('`b`','`SavesMade_PH(Players1,MatchComp0)`'),('`c`','`shot_eff_AT(Teams0,MatchComp0)`'),('`d`','`shot_eff_HT(Teams1,MatchComp0)`'),('`a`','`shot_eff_PA(Players0,MatchComp0)`'),('`b`','`shot_eff_PH(Players1,MatchComp0)`'),('`a`','`tackle_eff_PA(Players0,MatchComp0)`'),('`b`','`tackle_eff_PH(Players1,MatchComp0)`'),('`a`','`TimePlayed_PA(Players0,MatchComp0)`'),('`b`','`TimePlayed_PH(Players1,MatchComp0)`');
