...
INSERT INTO `ADT_RNodes_Star_From_List` VALUES ('`a`','`Players0_counts`'),('`b`','`Players1_counts`'),('`c`','`Teams0_counts`'),('`d`','`Teams1_counts`'),('`e`','`Teams0_counts`'),('`f`','`Teams1_counts`'),('`a`','`MatchComp0_counts`'),('`b`','`MatchComp0_counts`'),('`c`','`MatchComp0_counts`'),('`d`','`MatchComp0_counts`'),('`e`','`Players0_counts`'),('`f`','`Players1_counts`');
