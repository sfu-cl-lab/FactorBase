...
INSERT INTO `ADT_RNodes_False_WHERE_List` VALUES ('`a`','`a_star`.`Result(MatchComp0)`=`a_flat`.`Result(MatchComp0)`'),('`b`','`b_star`.`Result(MatchComp0)`=`b_flat`.`Result(MatchComp0)`'),('`c`','`c_star`.`Result(MatchComp0)`=`c_flat`.`Result(MatchComp0)`'),('`d`','`d_star`.`Result(MatchComp0)`=`d_flat`.`Result(MatchComp0)`');
