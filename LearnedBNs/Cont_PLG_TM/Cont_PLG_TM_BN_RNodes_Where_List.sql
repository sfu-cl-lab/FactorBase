...
INSERT INTO `RNodes_Where_List` VALUES ('`a`','`a`.PlayerID = Players0.PlayerID'),('`b`','`b`.PlayerID = Players1.PlayerID'),('`c`','`c`.TeamID = Teams0.TeamID'),('`d`','`d`.TeamID = Teams1.TeamID'),('`e`','`e`.TeamID = Teams0.TeamID'),('`f`','`f`.TeamID = Teams1.TeamID'),('`a`','`a`.MatchID = MatchComp0.MatchID'),('`b`','`b`.MatchID = MatchComp0.MatchID'),('`c`','`c`.MatchID = MatchComp0.MatchID'),('`d`','`d`.MatchID = MatchComp0.MatchID'),('`e`','`e`.PlayerID = Players0.PlayerID'),('`f`','`f`.PlayerID = Players1.PlayerID');
