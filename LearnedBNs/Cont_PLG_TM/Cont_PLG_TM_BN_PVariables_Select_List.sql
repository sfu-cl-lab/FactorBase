...
INSERT INTO `PVariables_Select_List` VALUES ('MatchComp0','count(*) as \"MULT\"'),('Players0','count(*) as \"MULT\"'),('Players1','count(*) as \"MULT\"'),('Teams0','count(*) as \"MULT\"'),('Teams1','count(*) as \"MULT\"'),('MatchComp0','MatchComp0.Result AS `Result(MatchComp0)`');
