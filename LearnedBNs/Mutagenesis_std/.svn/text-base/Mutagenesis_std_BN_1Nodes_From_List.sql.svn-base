...
INSERT INTO `1Nodes_From_List` VALUES ('`atype(Atom0)`','Atom AS Atom0'),('`charge(Atom0)`','Atom AS Atom0'),('`elem(Atom0)`','Atom AS Atom0'),('`ind1(Mole0)`','Mole AS Mole0'),('`inda(Mole0)`','Mole AS Mole0'),('`label(Mole0)`','Mole AS Mole0'),('`logp(Mole0)`','Mole AS Mole0'),('`lumo(Mole0)`','Mole AS Mole0');
