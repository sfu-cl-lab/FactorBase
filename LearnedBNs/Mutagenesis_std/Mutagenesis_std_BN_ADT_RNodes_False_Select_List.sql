...
INSERT INTO `ADT_RNodes_False_Select_List` VALUES ('`a`','(`a_star`.MULT-`a_flat`.MULT) AS \"MULT\"'),('`b`','(`b_star`.MULT-`b_flat`.MULT) AS \"MULT\"'),('`a`','`a_star`.`ind1(Mole0)`'),('`b`','`b_star`.`ind1(Mole0)`'),('`a`','`a_star`.`inda(Mole0)`'),('`b`','`b_star`.`inda(Mole0)`'),('`a`','`a_star`.`label(Mole0)`'),('`b`','`b_star`.`label(Mole0)`'),('`a`','`a_star`.`logp(Mole0)`'),('`b`','`b_star`.`logp(Mole0)`'),('`a`','`a_star`.`lumo(Mole0)`'),('`b`','`b_star`.`lumo(Mole0)`'),('`a`','`a_star`.`atype(Atom0)`'),('`b`','`b_star`.`atype(Atom0)`'),('`a`','`a_star`.`charge(Atom0)`'),('`b`','`b_star`.`charge(Atom0)`'),('`a`','`a_star`.`elem(Atom0)`'),('`b`','`b_star`.`elem(Atom0)`');
