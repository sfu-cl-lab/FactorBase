...
INSERT INTO `1NodePars` VALUES ('`atype(Atom0)`',14),('`a`',42),('`btype(Mole0,Atom0)`',42),('`b`',4),('`charge(Atom0)`',7),('`ind1(Mole0)`',2),('`inda(Mole0)`',10),('`logp(Mole0)`',4),('`lumo(Mole0)`',4),('`elem(Atom0)`',1),('`label(Mole0)`',1);
