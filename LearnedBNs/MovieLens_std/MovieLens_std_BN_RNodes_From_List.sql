...
INSERT INTO `RNodes_From_List` VALUES ('`a`','MovieLens_std.User AS User0'),('`a`','MovieLens_std.item2 AS item20'),('`a`','MovieLens_std.u2base AS `a`'),('`a`','(select \"T\" as `a`) as `temp_a`');
