...
INSERT INTO `Entity_Complement_Edges` VALUES ('item20','`action(item20)`','`action(item20)`'),('item20','`action(item20)`','`drama(item20)`'),('item20','`action(item20)`','`horror(item20)`'),('item20','`drama(item20)`','`drama(item20)`'),('item20','`horror(item20)`','`action(item20)`'),('item20','`horror(item20)`','`drama(item20)`'),('item20','`horror(item20)`','`horror(item20)`'),('User0','`Age(User0)`','`Age(User0)`'),('User0','`Age(User0)`','`Gender(User0)`'),('User0','`Gender(User0)`','`Age(User0)`'),('User0','`Gender(User0)`','`Gender(User0)`');
