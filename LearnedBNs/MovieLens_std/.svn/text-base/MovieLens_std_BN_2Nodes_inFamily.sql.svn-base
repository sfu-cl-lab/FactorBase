...
INSERT INTO `2Nodes_inFamily` VALUES ('`action(item20)`','`rating(User0,item20)`',5),('`Age(User0)`','`rating(User0,item20)`',5),('`drama(item20)`','`rating(User0,item20)`',5),('`Gender(User0)`','`rating(User0,item20)`',5);
