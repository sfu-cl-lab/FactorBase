...
INSERT INTO `Entity_BayesNets` VALUES ('item20','`action(item20)`',''),('item20','`drama(item20)`','`action(item20)`'),('item20','`drama(item20)`','`horror(item20)`'),('item20','`horror(item20)`',''),('User0','`Age(User0)`',''),('User0','`Gender(User0)`','');
