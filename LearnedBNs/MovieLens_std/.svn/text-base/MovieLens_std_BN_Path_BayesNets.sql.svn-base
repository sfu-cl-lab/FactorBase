...
INSERT INTO `Path_BayesNets` VALUES ('`a`','`action(item20)`','`rating(User0,item20)`'),('`a`','`Age(User0)`','`action(item20)`'),('`a`','`Age(User0)`','`rating(User0,item20)`'),('`a`','`a`',''),('`a`','`drama(item20)`','`action(item20)`'),('`a`','`drama(item20)`','`horror(item20)`'),('`a`','`drama(item20)`','`rating(User0,item20)`'),('`a`','`Gender(User0)`','`action(item20)`'),('`a`','`Gender(User0)`','`rating(User0,item20)`'),('`a`','`horror(item20)`',''),('`a`','`rating(User0,item20)`','`a`'),('`a`','`rating(User0,item20)`','`horror(item20)`');
