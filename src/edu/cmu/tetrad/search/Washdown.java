 ...
 * <p/>
 * 1) Purify step:  run Purify on current model.
 ...
 * passes, else current model:= new model, and go to step 1.
 * <p/>
 * Purify
 * 1) Vkeep := V, Vdiscard := null set
 * 2) Do goodness-of-fit test on current model Mc, stop if Mc passes,
 ...
 * 3) New current model := Mc - Vi, for Vi with max gof(Vi) from step 3.
