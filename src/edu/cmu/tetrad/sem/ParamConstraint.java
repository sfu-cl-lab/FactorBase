...
/**
 * A class for implementing constraints on the values of the parameters of of
 ...
 * the relative values of two parameters.  There is a companion class
...
public class ParamConstraint implements TetradSerializable {
     ...
     * parameters' values are determined by it.
     */
    ...
    /**
     * The second constructor specifies two parameters and the type of relation
...
//    }
     ...
     * searches possible values of parameters to find that value which is
