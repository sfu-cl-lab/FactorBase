...
//			e.printStackTrace();
     ...
     *
     * @param node         current node of the ClassifierTree
     * @param current_rule current stack of predicates
     * @param global_rules global rules that will be returned
     * @throws Exception
     */
...
//		System.out.println(nodeList);
     ...
     *
     * @param csvStr a string of csv file
