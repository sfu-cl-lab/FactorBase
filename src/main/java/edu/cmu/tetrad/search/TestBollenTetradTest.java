 ...
 */
public class TestBollenTetradTest extends TestCase {

    /**
     * Standard constructor for JUnit test cases.
     */
    public TestBollenTetradTest(String name) {
        super(name);
    }
...
//                BollenTingTetradTest test = new BollenTingTetradTest(data);
//                BollenTingTetradTest test = new BollenTingTetradTest(new CovarianceMatrix(data));
                BollenTingTetradTest test = new BollenTingTetradTest(new CorrelationMatrix(data));
...
//                if (p7 < alpha) count[6]++;
    ...
    public void testBollenExample1() {
        ...
        BollenTingTetradTest test = new BollenTingTetradTest(cov);
//        BollenTingTetradTest test = new BollenTingTetradTest(new CorrelationMatrix(cov));
...
//        params.setCoefRange(0.3, 0.8);
    ...
    private CovarianceMatrix getBollenExample1Data() {
        ...
        DoubleMatrix2D matrix = new DenseDoubleMatrix2D(6, 6);
    ...
    private CovarianceMatrix getBollenExample2Data() {
        ...
        DoubleMatrix2D matrix = new DenseDoubleMatrix2D(5, 5);
