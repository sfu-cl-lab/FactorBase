...
INSERT INTO `ADT_PVariables_From_List` VALUES ('Bio0','Hepatitis_std.Bio AS Bio0'),('dispat0','Hepatitis_std.dispat AS dispat0'),('indis0','Hepatitis_std.indis AS indis0'),('inf0','Hepatitis_std.inf AS inf0');
