...
--
-- Table structure for table `NumAttributes`
--

DROP TABLE IF EXISTS `NumAttributes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `NumAttributes` (
...
--
-- Dumping data for table `NumAttributes`
--

LOCK TABLES `NumAttributes` WRITE;
/*!40000 ALTER TABLE `NumAttributes` DISABLE KEYS */;
INSERT INTO `NumAttributes` VALUES ('activity',5),('age',7),('alb',2),('che',10),('dbil',2),('dur',5),('fibros',5),('got',5),('gpt',4),('sex',2),('tbil',2),('tcho',4),('tp',4),('ttt',6),('Type',2),('ztt',6),('`a`',2),('`b`',2),('`c`',2);
