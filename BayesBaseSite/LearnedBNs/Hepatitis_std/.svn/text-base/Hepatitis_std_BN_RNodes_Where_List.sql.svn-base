...
INSERT INTO `RNodes_Where_List` VALUES ('`a`','`a`.b_id = Bio0.b_id'),('`b`','`b`.in_id = indis0.in_id'),('`c`','`c`.a_id = inf0.a_id'),('`a`','`a`.m_id = dispat0.m_id'),('`b`','`b`.m_id = dispat0.m_id'),('`c`','`c`.m_id = dispat0.m_id');
