...
INSERT INTO `RNodes_pvars` VALUES ('`a`','Bio0','Bio','b_id','b_id'),('`b`','indis0','indis','in_id','in_id'),('`c`','inf0','inf','a_id','a_id'),('`a`','dispat0','dispat','m_id','m_id'),('`b`','dispat0','dispat','m_id','m_id'),('`c`','dispat0','dispat','m_id','m_id');
