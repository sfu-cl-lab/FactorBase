...
INSERT INTO `RNodes_Select_List` VALUES ('`a`','count(*) as \"MULT\"'),('`b`','count(*) as \"MULT\"'),('`a`','Mole0.ind1 AS `ind1(Mole0)`'),('`b`','Mole0.ind1 AS `ind1(Mole0)`'),('`a`','Mole0.inda AS `inda(Mole0)`'),('`b`','Mole0.inda AS `inda(Mole0)`'),('`a`','Mole0.label AS `label(Mole0)`'),('`b`','Mole0.label AS `label(Mole0)`'),('`a`','Mole0.logp AS `logp(Mole0)`'),('`b`','Mole0.logp AS `logp(Mole0)`'),('`a`','Mole0.lumo AS `lumo(Mole0)`'),('`b`','Mole0.lumo AS `lumo(Mole0)`'),('`a`','Atom0.atype AS `atype(Atom0)`'),('`b`','Atom0.atype AS `atype(Atom0)`'),('`a`','Atom0.charge AS `charge(Atom0)`'),('`b`','Atom0.charge AS `charge(Atom0)`'),('`a`','Atom0.elem AS `elem(Atom0)`'),('`b`','Atom0.elem AS `elem(Atom0)`'),('`a`','`a`.btype AS `btype(Mole0,Atom0)`'),('`a`','`a`'),('`b`','`b`');
