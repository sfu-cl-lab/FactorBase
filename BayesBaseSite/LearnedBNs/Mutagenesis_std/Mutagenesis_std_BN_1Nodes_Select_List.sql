...
INSERT INTO `1Nodes_Select_List` VALUES ('`atype(Atom0)`','Atom0.atype AS `atype(Atom0)`'),('`charge(Atom0)`','Atom0.charge AS `charge(Atom0)`'),('`elem(Atom0)`','Atom0.elem AS `elem(Atom0)`'),('`ind1(Mole0)`','Mole0.ind1 AS `ind1(Mole0)`'),('`inda(Mole0)`','Mole0.inda AS `inda(Mole0)`'),('`label(Mole0)`','Mole0.label AS `label(Mole0)`'),('`logp(Mole0)`','Mole0.logp AS `logp(Mole0)`'),('`lumo(Mole0)`','Mole0.lumo AS `lumo(Mole0)`');
