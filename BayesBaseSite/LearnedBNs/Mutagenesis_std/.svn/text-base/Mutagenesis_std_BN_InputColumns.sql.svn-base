...
INSERT INTO `InputColumns` VALUES ('Atom','a_id',NULL,NULL,'PRIMARY',1),('bond','a_id',NULL,NULL,'PRIMARY',2),('bond','m_id',NULL,NULL,'PRIMARY',1),('Mole','m_id',NULL,NULL,'PRIMARY',1),('moleatm','m_id',NULL,NULL,'PRIMARY',1),('moleatm','a_id',NULL,NULL,'PRIMARY',2);
