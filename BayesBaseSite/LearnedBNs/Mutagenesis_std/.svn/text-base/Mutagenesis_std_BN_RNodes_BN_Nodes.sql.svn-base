...
INSERT INTO `RNodes_BN_Nodes` VALUES ('`a`','`ind1(Mole0)`',1),('`b`','`ind1(Mole0)`',1),('`a`','`inda(Mole0)`',1),('`b`','`inda(Mole0)`',1),('`a`','`label(Mole0)`',1),('`b`','`label(Mole0)`',1),('`a`','`logp(Mole0)`',1),('`b`','`logp(Mole0)`',1),('`a`','`lumo(Mole0)`',1),('`b`','`lumo(Mole0)`',1),('`a`','`atype(Atom0)`',1),('`b`','`atype(Atom0)`',1),('`a`','`charge(Atom0)`',1),('`b`','`charge(Atom0)`',1),('`a`','`elem(Atom0)`',1),('`b`','`elem(Atom0)`',1),('`a`','`btype(Mole0,Atom0)`',1);
