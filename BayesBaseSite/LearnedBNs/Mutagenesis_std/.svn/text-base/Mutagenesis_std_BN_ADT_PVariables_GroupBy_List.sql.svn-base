...
INSERT INTO `ADT_PVariables_GroupBy_List` VALUES ('Atom0','`atype(Atom0)`'),('Atom0','`charge(Atom0)`'),('Atom0','`elem(Atom0)`'),('Mole0','`ind1(Mole0)`'),('Mole0','`inda(Mole0)`'),('Mole0','`label(Mole0)`'),('Mole0','`logp(Mole0)`'),('Mole0','`lumo(Mole0)`');
