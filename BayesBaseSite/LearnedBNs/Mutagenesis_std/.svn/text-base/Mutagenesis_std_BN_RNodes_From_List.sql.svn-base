...
CREATE TABLE `RNodes_From_List` (
  ...
  `Entries` varchar(149) character set utf8 default NULL
...
INSERT INTO `RNodes_From_List` VALUES ('`a`','Mutagenesis_std.Mole AS Mole0'),('`b`','Mutagenesis_std.Mole AS Mole0'),('`a`','Mutagenesis_std.Atom AS Atom0'),('`b`','Mutagenesis_std.Atom AS Atom0'),('`a`','Mutagenesis_std.bond AS `a`'),('`b`','Mutagenesis_std.moleatm AS `b`'),('`a`','(select \"T\" as `a`) as `temp_a`'),('`b`','(select \"T\" as `b`) as `temp_b`');
