...
INSERT INTO `InheritedEdges` VALUES ('`a,b`','`atype(Atom0)`','`charge(Atom0)`'),('`a,b`','`atype(Atom0)`','`elem(Atom0)`'),('`a,b`','`a`','`atype(Atom0)`'),('`a,b`','`a`','`elem(Atom0)`'),('`a,b`','`a`','`ind1(Mole0)`'),('`a,b`','`btype(Mole0,Atom0)`','`atype(Atom0)`'),('`a,b`','`btype(Mole0,Atom0)`','`a`'),('`a,b`','`btype(Mole0,Atom0)`','`charge(Atom0)`'),('`a,b`','`btype(Mole0,Atom0)`','`elem(Atom0)`'),('`a,b`','`b`','`charge(Atom0)`'),('`a,b`','`b`','`ind1(Mole0)`'),('`a,b`','`charge(Atom0)`','`elem(Atom0)`'),('`a,b`','`ind1(Mole0)`','`label(Mole0)`'),('`a,b`','`inda(Mole0)`','`a`'),('`a,b`','`inda(Mole0)`','`btype(Mole0,Atom0)`'),('`a,b`','`inda(Mole0)`','`b`'),('`a,b`','`inda(Mole0)`','`logp(Mole0)`'),('`a,b`','`logp(Mole0)`','`ind1(Mole0)`'),('`a,b`','`logp(Mole0)`','`label(Mole0)`'),('`a,b`','`lumo(Mole0)`','`inda(Mole0)`'),('`a,b`','`lumo(Mole0)`','`label(Mole0)`');
