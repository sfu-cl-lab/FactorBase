...
CREATE TABLE `ChildPars` (
  `NumPars` bigint(21) NOT NULL default '0',
...
INSERT INTO `ChildPars` VALUES (2,'`atype(Atom0)`'),(5,'`btype(Mole0,Atom0)`'),(1,'`charge(Atom0)`'),(6,'`elem(Atom0)`'),(1,'`ind1(Mole0)`'),(1,'`inda(Mole0)`'),(1,'`label(Mole0)`'),(9,'`logp(Mole0)`'),(8,'`lumo(Mole0)`'),(1,'`a`'),(1,'`b`');
