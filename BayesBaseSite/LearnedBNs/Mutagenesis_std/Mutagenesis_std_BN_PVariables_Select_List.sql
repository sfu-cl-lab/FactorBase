...
INSERT INTO `PVariables_Select_List` VALUES ('Atom0','count(*) as \"MULT\"'),('Mole0','count(*) as \"MULT\"'),('Atom0','Atom0.atype AS `atype(Atom0)`'),('Atom0','Atom0.charge AS `charge(Atom0)`'),('Atom0','Atom0.elem AS `elem(Atom0)`'),('Mole0','Mole0.ind1 AS `ind1(Mole0)`'),('Mole0','Mole0.inda AS `inda(Mole0)`'),('Mole0','Mole0.label AS `label(Mole0)`'),('Mole0','Mole0.logp AS `logp(Mole0)`'),('Mole0','Mole0.lumo AS `lumo(Mole0)`');
