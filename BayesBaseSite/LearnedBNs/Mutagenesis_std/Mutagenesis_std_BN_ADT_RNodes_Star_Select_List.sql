...
INSERT INTO `ADT_RNodes_Star_Select_List` VALUES ('`a`','`ind1(Mole0)`'),('`b`','`ind1(Mole0)`'),('`a`','`inda(Mole0)`'),('`b`','`inda(Mole0)`'),('`a`','`label(Mole0)`'),('`b`','`label(Mole0)`'),('`a`','`logp(Mole0)`'),('`b`','`logp(Mole0)`'),('`a`','`lumo(Mole0)`'),('`b`','`lumo(Mole0)`'),('`a`','`atype(Atom0)`'),('`b`','`atype(Atom0)`'),('`a`','`charge(Atom0)`'),('`b`','`charge(Atom0)`'),('`a`','`elem(Atom0)`'),('`b`','`elem(Atom0)`');
