...
INSERT INTO `RNodes_1Nodes` VALUES ('`a`','AppearsPlayerAway','`Result(MatchComp0)`','Result','MatchComp0'),('`b`','AppearsPlayerHome','`Result(MatchComp0)`','Result','MatchComp0'),('`c`','AppearsTeamAway','`Result(MatchComp0)`','Result','MatchComp0'),('`d`','AppearsTeamHome','`Result(MatchComp0)`','Result','MatchComp0');
