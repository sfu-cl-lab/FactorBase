...
CREATE TABLE `RNodes_From_List` (
  ...
  `Entries` varchar(148) CHARACTER SET utf8 DEFAULT NULL
...
INSERT INTO `RNodes_From_List` VALUES ('`a`','imdb_MovieLens.movies AS movies0'),('`b`','imdb_MovieLens.movies AS movies0'),('`c`','imdb_MovieLens.users AS users0'),('`a`','imdb_MovieLens.actors AS actors0'),('`b`','imdb_MovieLens.directors AS directors0'),('`c`','imdb_MovieLens.movies AS movies0'),('`a`','imdb_MovieLens.movies2actors AS `a`'),('`b`','imdb_MovieLens.movies2directors AS `b`'),('`c`','imdb_MovieLens.u2base AS `c`');
