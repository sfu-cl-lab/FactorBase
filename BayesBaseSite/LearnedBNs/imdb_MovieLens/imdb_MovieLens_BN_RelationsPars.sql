...
INSERT INTO `RelationsPars` VALUES ('`age(users0)`',4.999999999999999),('`country(movies0)`',4.999999999999999),('`d_quality(directors0)`',6),('`genre(movies0,directors0)`',29.99999999999999),('`occupation(users0)`',6),('`rating(users0,movies0)`',4.999999999999999),('`u_gender(users0)`',6);
