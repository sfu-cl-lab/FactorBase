...
INSERT INTO `ADT_RNodes_Star_Select_List` VALUES ('`c`','`age(users0)`'),('`a`','`country(movies0)`'),('`b`','`country(movies0)`'),('`a`','`isEnglish(movies0)`'),('`b`','`isEnglish(movies0)`'),('`c`','`occupation(users0)`'),('`a`','`runningtime(movies0)`'),('`b`','`runningtime(movies0)`'),('`c`','`u_gender(users0)`'),('`a`','`year(movies0)`'),('`b`','`year(movies0)`'),('`b`','`avg_revenue(directors0)`'),('`a`','`a_gender(actors0)`'),('`a`','`a_quality(actors0)`'),('`c`','`country(movies0)`'),('`b`','`d_quality(directors0)`'),('`c`','`isEnglish(movies0)`'),('`c`','`runningtime(movies0)`'),('`c`','`year(movies0)`');
