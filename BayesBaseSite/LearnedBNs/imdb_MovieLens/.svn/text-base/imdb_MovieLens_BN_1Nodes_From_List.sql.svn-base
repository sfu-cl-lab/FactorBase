...
INSERT INTO `1Nodes_From_List` VALUES ('`age(users0)`','users AS users0'),('`avg_revenue(directors0)`','directors AS directors0'),('`a_gender(actors0)`','actors AS actors0'),('`a_quality(actors0)`','actors AS actors0'),('`country(movies0)`','movies AS movies0'),('`d_quality(directors0)`','directors AS directors0'),('`isEnglish(movies0)`','movies AS movies0'),('`occupation(users0)`','users AS users0'),('`runningtime(movies0)`','movies AS movies0'),('`u_gender(users0)`','users AS users0'),('`year(movies0)`','movies AS movies0');
