...
INSERT INTO `RelationsParents` VALUES ('`age(users0)`','`a`','`cast_num(movies0,actors0)`',4),('`country(movies0)`','`a`','`cast_num(movies0,actors0)`',4),('`genre(movies0,directors0)`','`a`','`cast_num(movies0,actors0)`',4),('`rating(users0,movies0)`','`a`','`cast_num(movies0,actors0)`',4),('`d_quality(directors0)`','`c`','`rating(users0,movies0)`',5),('`genre(movies0,directors0)`','`c`','`rating(users0,movies0)`',5),('`occupation(users0)`','`c`','`rating(users0,movies0)`',5),('`u_gender(users0)`','`c`','`rating(users0,movies0)`',5);
