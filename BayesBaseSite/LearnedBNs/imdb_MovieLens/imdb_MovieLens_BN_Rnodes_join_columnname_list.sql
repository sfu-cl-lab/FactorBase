...
INSERT INTO `Rnodes_join_columnname_list` VALUES ('`a`','`cast_num(movies0,actors0)` varchar(5)  default  \"N/A\" '),('`b`','`genre(movies0,directors0)` varchar(5)  default  \"N/A\" '),('`c`','`rating(users0,movies0)` varchar(5)  default  \"N/A\" ');
