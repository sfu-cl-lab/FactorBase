...
INSERT INTO `RelationsParents` VALUES ('`action(item20)`','`a`','`rating(User0,item20)`',5),('`Age(User0)`','`a`','`rating(User0,item20)`',5),('`drama(item20)`','`a`','`rating(User0,item20)`',5),('`Gender(User0)`','`a`','`rating(User0,item20)`',5),('`rating(User0,item20)`','`a`','`a`',1);
