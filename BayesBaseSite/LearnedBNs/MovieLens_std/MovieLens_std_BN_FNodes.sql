...
INSERT INTO `FNodes` VALUES ('`action(item20)`','action','1Node',1),('`Age(User0)`','Age','1Node',1),('`a`','`a`','Rnode',1),('`drama(item20)`','drama','1Node',1),('`Gender(User0)`','Gender','1Node',1),('`horror(item20)`','horror','1Node',1),('`rating(User0,item20)`','rating','2Node',1);
