...
INSERT INTO `RNodes` VALUES ('`RA(prof0,student0)`','RA','prof0','student0','prof_id','student_id',1,'`a`'),('`registration(course0,student0)`','registration','course0','student0','course_id','student_id',1,'`b`');
