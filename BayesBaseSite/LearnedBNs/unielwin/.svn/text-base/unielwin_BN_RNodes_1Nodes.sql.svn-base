...
INSERT INTO `RNodes_1Nodes` VALUES ('`b`','registration','`diff(course0)`','diff','course0'),('`a`','RA','`popularity(prof0)`','popularity','prof0'),('`b`','registration','`rating(course0)`','rating','course0'),('`a`','RA','`teachingability(prof0)`','teachingability','prof0'),('`a`','RA','`intelligence(student0)`','intelligence','student0'),('`b`','registration','`intelligence(student0)`','intelligence','student0'),('`a`','RA','`ranking(student0)`','ranking','student0'),('`b`','registration','`ranking(student0)`','ranking','student0');
