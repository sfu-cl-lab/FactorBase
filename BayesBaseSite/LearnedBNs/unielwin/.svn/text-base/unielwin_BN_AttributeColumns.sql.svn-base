...
INSERT INTO `AttributeColumns` VALUES ('course','diff'),('course','rating'),('prof','popularity'),('prof','teachingability'),('RA','capability'),('RA','salary'),('registration','grade'),('registration','sat'),('student','intelligence'),('student','ranking');
