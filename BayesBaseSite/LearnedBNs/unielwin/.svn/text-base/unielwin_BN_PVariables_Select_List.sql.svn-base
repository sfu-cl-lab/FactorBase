...
INSERT INTO `PVariables_Select_List` VALUES ('course0','count(*) as \"MULT\"'),('prof0','count(*) as \"MULT\"'),('student0','count(*) as \"MULT\"'),('course0','course0.diff AS `diff(course0)`'),('student0','student0.intelligence AS `intelligence(student0)`'),('prof0','prof0.popularity AS `popularity(prof0)`'),('student0','student0.ranking AS `ranking(student0)`'),('course0','course0.rating AS `rating(course0)`'),('prof0','prof0.teachingability AS `teachingability(prof0)`');
