...
--
-- Table structure for table `RNodes_2Nodes_Family`
--

DROP TABLE IF EXISTS `RNodes_2Nodes_Family`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `RNodes_2Nodes_Family` (
...
--
-- Dumping data for table `RNodes_2Nodes_Family`
--

LOCK TABLES `RNodes_2Nodes_Family` WRITE;
/*!40000 ALTER TABLE `RNodes_2Nodes_Family` DISABLE KEYS */;
INSERT INTO `RNodes_2Nodes_Family` VALUES ('`b`','`a`','`salary(prof0,student0)`',3),('`salary(prof0,student0)`','`a`','`capability(prof0,student0)`',5),('`sat(course0,student0)`','`b`','`grade(course0,student0)`',4);
