...
INSERT INTO `SchemaEdges` VALUES ('`a,b`','`capability(prof0,student0)`','`a`'),('`a,b`','`grade(course0,student0)`','`b`'),('`a,b`','`salary(prof0,student0)`','`a`'),('`a,b`','`sat(course0,student0)`','`b`'),('`a`','`capability(prof0,student0)`','`a`'),('`a`','`salary(prof0,student0)`','`a`'),('`b`','`grade(course0,student0)`','`b`'),('`b`','`sat(course0,student0)`','`b`');
