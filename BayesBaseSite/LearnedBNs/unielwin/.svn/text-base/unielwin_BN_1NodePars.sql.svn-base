...
INSERT INTO `1NodePars` VALUES ('`a`',2),('`grade(course0,student0)`',3),('`popularity(prof0)`',2),('`ranking(student0)`',3),('`b`',1),('`capability(prof0,student0)`',1),('`diff(course0)`',1),('`intelligence(student0)`',1),('`rating(course0)`',1),('`salary(prof0,student0)`',1),('`sat(course0,student0)`',1),('`teachingability(prof0)`',1);
