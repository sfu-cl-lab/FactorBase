...
INSERT INTO `2Nodes` VALUES ('`capability(prof0,student0)`','capability','prof0','student0','RA',1),('`grade(course0,student0)`','grade','course0','student0','registration',1),('`salary(prof0,student0)`','salary','prof0','student0','RA',1),('`sat(course0,student0)`','sat','course0','student0','registration',1);
