...
INSERT INTO `ADT_RNodes_False_Select_List` VALUES ('`a`','(`a_star`.MULT-`a_flat`.MULT) AS \"MULT\"'),('`b`','(`b_star`.MULT-`b_flat`.MULT) AS \"MULT\"'),('`b`','`b_star`.`diff(course0)`'),('`a`','`a_star`.`popularity(prof0)`'),('`b`','`b_star`.`rating(course0)`'),('`a`','`a_star`.`teachingability(prof0)`'),('`a`','`a_star`.`intelligence(student0)`'),('`b`','`b_star`.`intelligence(student0)`'),('`a`','`a_star`.`ranking(student0)`'),('`b`','`b_star`.`ranking(student0)`');
