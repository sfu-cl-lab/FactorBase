...
INSERT INTO `1Nodes` VALUES ('`diff(course0)`','diff','course0',1),('`intelligence(student0)`','intelligence','student0',1),('`popularity(prof0)`','popularity','prof0',1),('`ranking(student0)`','ranking','student0',1),('`rating(course0)`','rating','course0',1),('`teachingability(prof0)`','teachingability','prof0',1);
