...
CREATE TABLE `ForeignKeys_pvars` (
  ...
  `ARGUMENT_POSITION` bigint(21) NOT NULL default '0'
...
INSERT INTO `ForeignKeys_pvars` VALUES ('RA','prof','prof_id','prof0',0,2),('RA','student','student_id','student0',0,3),('registration','course','course_id','course0',0,1),('registration','student','student_id','student0',0,2);
