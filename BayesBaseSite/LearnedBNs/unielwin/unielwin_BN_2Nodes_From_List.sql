...
INSERT INTO `2Nodes_From_List` VALUES ('`capability(prof0,student0)`','RA AS `a`'),('`grade(course0,student0)`','registration AS `b`'),('`salary(prof0,student0)`','RA AS `a`'),('`sat(course0,student0)`','registration AS `b`');
