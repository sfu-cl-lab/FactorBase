...
INSERT INTO `Rnodes_join_columnname_list` VALUES ('`a`','`capability(prof0,student0)` varchar(5)  default  \"N/A\" '),('`b`','`grade(course0,student0)` varchar(5)  default  \"N/A\" '),('`a`','`salary(prof0,student0)` varchar(5)  default  \"N/A\" '),('`b`','`sat(course0,student0)` varchar(5)  default  \"N/A\" ');
