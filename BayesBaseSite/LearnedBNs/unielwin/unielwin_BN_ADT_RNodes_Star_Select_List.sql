...
INSERT INTO `ADT_RNodes_Star_Select_List` VALUES ('`b`','`diff(course0)`'),('`a`','`popularity(prof0)`'),('`b`','`rating(course0)`'),('`a`','`teachingability(prof0)`'),('`a`','`intelligence(student0)`'),('`b`','`intelligence(student0)`'),('`a`','`ranking(student0)`'),('`b`','`ranking(student0)`');
