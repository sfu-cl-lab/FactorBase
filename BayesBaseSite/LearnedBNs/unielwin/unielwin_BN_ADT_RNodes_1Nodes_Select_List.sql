...
INSERT INTO `ADT_RNodes_1Nodes_Select_List` VALUES ('`a`','sum(`a_counts`.`MULT`) as \"MULT\"'),('`b`','sum(`b_counts`.`MULT`) as \"MULT\"'),('`b`','`diff(course0)`'),('`a`','`popularity(prof0)`'),('`b`','`rating(course0)`'),('`a`','`teachingability(prof0)`'),('`a`','`intelligence(student0)`'),('`b`','`intelligence(student0)`'),('`a`','`ranking(student0)`'),('`b`','`ranking(student0)`');
