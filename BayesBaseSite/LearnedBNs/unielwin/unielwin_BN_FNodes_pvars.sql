...
INSERT INTO `FNodes_pvars` VALUES ('`capability(prof0,student0)`','prof0'),('`grade(course0,student0)`','course0'),('`salary(prof0,student0)`','prof0'),('`sat(course0,student0)`','course0'),('`capability(prof0,student0)`','student0'),('`grade(course0,student0)`','student0'),('`salary(prof0,student0)`','student0'),('`sat(course0,student0)`','student0'),('`diff(course0)`','course0'),('`intelligence(student0)`','student0'),('`popularity(prof0)`','prof0'),('`ranking(student0)`','student0'),('`rating(course0)`','course0'),('`teachingability(prof0)`','prof0');
