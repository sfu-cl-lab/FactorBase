...
INSERT INTO `1Nodes_From_List` VALUES ('`diff(course0)`','course AS course0'),('`intelligence(student0)`','student AS student0'),('`popularity(prof0)`','prof AS prof0'),('`ranking(student0)`','student AS student0'),('`rating(course0)`','course AS course0'),('`teachingability(prof0)`','prof AS prof0');
