...
INSERT INTO `2Nodes_inFamily` VALUES ('`salary(prof0,student0)`','`capability(prof0,student0)`',5),('`diff(course0)`','`grade(course0,student0)`',4),('`sat(course0,student0)`','`grade(course0,student0)`',4),('`b`','`salary(prof0,student0)`',3);
